    ...
    class Purchase_OrderDAL
    {
        ...
        public DataTable SelectPurchaseOrders(string PoNo)
        {
            ...
            try
            {
                ...
                string sql = "SELECT po_date, ticket_name, draw_date, order_quantity, recieved_quantity, supplier, unit_price FROM purchase_order WHERE po_no=@po_no AND (order_quantity - recieved_quantity) > 0 ";              
